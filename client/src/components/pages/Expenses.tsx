...
const catColors: Record<string, string> = {
    Salaries: "var(--indigo)",
    Freelancers: "var(--emerald)",
    Rent: "var(--blue)",
    Software: "var(--amber)",
    Marketing: "var(--red)",
    "Content Shoots": "var(--amber)",
    Travel: "var(--blue)",
    Utilities: "var(--text3)",
    Miscellaneous: "var(--text3)",
};
    ...
    const save = async () => {
        ...
        try {
            ...
            if (editing) {
                ...
                setExpenses((prev) =>
                    prev.map((e) =>
                        e._id === editing._id ? (updated as Expense) : e,
                    ),
                );
            } else {
                            ...
                            <tbody>
                                {displayed.map((exp) => (
                                    <tr key={exp._id}>
                                        ...
                                        <td>
                                            <span
                                                className={`badge ${categoryBadge[exp.category] || "bb"}`}
                                            >
                                                {exp.category}
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                className={`badge ${typeBadge[exp.type]}`}
                                            >
                                                {exp.type}
                                            </span>
                                        </td>
